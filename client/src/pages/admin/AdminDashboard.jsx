                ...
                {upcomingEvents.map(
                  (event) => (
                    <button
                      ...
                      className="group flex w-full items-center gap-4 rounded-2xl border border-slate-100 bg-slate-50 p-4 text-left transition hover:border-slate-200 hover:bg-white hover:shadow-sm"
                    >
